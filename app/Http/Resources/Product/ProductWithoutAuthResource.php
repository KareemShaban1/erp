...
use App\Http\Resources\Variation\VariationWithoutAuthCollection;
use App\Http\Resources\VariationLocationDetails\VariationLocationDetailsCollection;
use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\JsonResource;

class ProductWithoutAuthResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        if ($this->withFullData) {
            ...
            $data = array_merge($data, [
                ...
                'variations' => (new VariationWithoutAuthCollection($variations))->withFullData(true),
            ]);
        }
