...
<!-- Main Header pop up for home page  -->
      ...
      <!-- <button  type="button" data-href="{{ action('ApplicationDashboard\HomeController@index')}}" class="btn btn-warning btn-flat pull-left m-8 btn-sm mt-10" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <button id="btnCalculator" title="@lang('lang_v1.calculator')" type="button" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10 popover-default hidden-xs" data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
            <strong><i class="fa fa-calculator fa-lg" aria-hidden="true"></i></strong>
                   ...
                   <button id="btnterms" title="الشروط والاحكام : تحديث جديد" type="button" onclick="location.href='https://smartly.software/publish/101fec34-f8da-4c56-839a-8f3ef7c7f77e'" class="btn btn-danger"  data-trigger="click" >
الشروط والاحكام :تحديث جديد
            <strong><i class="fa fa-help fa-lg" aria-hidden="true"></i></strong>
        </button>
