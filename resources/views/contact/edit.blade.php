      ...
      <div class="row">
        ...
        <div class="client_fields" style="display: none; margin:15px">
           ...
           <div class="col-md-4" >
            ...
            <div class="col-md-4" >
            <div class="form-group">
                    {!! Form::label('client_account_status', __('business.account_status') . ':*' ) !!}
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="fa fa-user"></i>
                        </span>
           ...
           <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('client_shipping_cost', __( 'lang_1.shipping_cost' ) . ':') !!}
                    {!! Form::text('client_shipping_cost', $client->shipping_cost, ['class' => 'form-control', 'placeholder' => __( 'lang_1.shipping_cost' ) ]); !!}
                </div>
            </div>
            <div class="col-md-3">
            <div class="form-group">
           ...
           <div class="col-md-4" >
            ...
            <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        ['active' => __('lang_v1.active'), 'deleted' => __('lang_v1.deleted')]
                        , $delivery->account_status , ['class' => 'form-control','placeholder' => __('messages.please_select'), 'required']); !!}
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 lead_additional_div">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  {!! Form::select('user_id[]', $users, $lead_users , ['class' => 'form-control select2', 'id' => 'user_id', 'multiple', 'style' => 'width: 100%;']); !!}
              </div>
          </div>
        </div>

        <div class="col-md-12">
            <button type="button" class="btn btn-primary center-block more_btn" data-target="#more_div_edit_contact">@lang('lang_v1.more_info') <i class="fa fa-chevron-down"></i></button>
        </div>
        
        <div id="more_div_edit_contact" class="hide">
