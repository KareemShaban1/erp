                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                                                ...
                                                                                                                                                                <td>
                                                                                                                                                                                      <button class="btn btn-warning"
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  onclick="editSetting({{ $setting->id }})">{{ __('lang_v1.edit')}}</button>

                                                                                                                                                                                      <form action="{{ route('application_settings.destroy', $setting->id) }}"
                                                                                                                                                                                                                  method="POST" style="display:inline;">
                                                                                                                                                                                                                  @csrf
                                                                                                                                                                                                                  @method('DELETE')
                                                                                                                                                                                                                  <button type="submit"
                                                                                                                                                                                                                                        class="btn btn-danger"
                                                                                                                                                                                                                                        onclick="return confirm('Are you sure?')">{{ __('lang_v1.delete')}}</button>
                                                                                                                                                                                      </form>
                                                                                                                                                                </td>
                                                                                                                                    </tr>
                                                                                                                          @endforeach
...
<div class="modal fade" id="createSettingModal" tabindex="-1" role="dialog" aria-labelledby="createSettingModalLabel"
          ...
          <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                              <form method="POST" action="{{ route('application_settings.store') }}"
                                        ...
                                        <div class="modal-body">
                                                  ...
                                                  <div class="form-group">
                                                            <label for="type">{{ __('lang_v1.value')}}</label>
                                                  ...
                                                  <div class="form-group" id="createValueGroup">
                                                            ...
                                                            <input type="text" name="value" id="createValue"
                                                                      class="form-control" required>
                                                  </div>
                                                  <div class="form-group" id="createBooleanOptions"
                                                            style="display:none;">
                                                  ...
                                                  <div class="form-group" id="createTextareaGroup"
                                                            style="display:none;">
                                                            <label for="value">Text Value</label>
                                                            <!-- {!! Form::textarea('value', null, ['class' => 'form-control']); !!} -->

                                                            <textarea name="value" id="createTextarea"
                              ...
                              <form method="POST" id="editSettingForm" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                                  <div class="form-group">
                                                            ...
                                                            <input type="text" name="key" id="editKey"
                                                                      class="form-control" required>
                                                  </div>
                                                  <div class="form-group">
                                                  ...
                                                  <div class="form-group" id="editBooleanOptions" style="display:none;">
                                                            ...
                                                            <div>
                                                                      <input type="radio" name="value"
                                                                                id="editValueTrue" value="true"> True
                                                                      <input type="radio" name="value"
                                                                                id="editValueFalse" value="false"> False
                                                            </div>
                                                  </div>
                                                  <div class="form-group" id="editTextareaGroup" style="display:none;">
                                                            <label for="value">Text Value</label>

                                                            <textarea name="value" id="editTextarea"
                                                                      class="form-control" rows="4"></textarea>
                                                  </div>
                                        </div>
                                        <div class="modal-footer">
...
<script>
          ...
          function editSetting(id) {
                    // Make an AJAX request to get the setting details
                    $.ajax({
                              url: '/applicationDashboard/settings/show/' + id, // Replace with your route to fetch the setting details
                              method: 'GET',
                              success: function (response) {
                                        ...
                                        $('#editType').val(setting.type).trigger('change'); // Trigger change to update the input dynamically

                                        // Set the value based on the type of the setting
                                        if (setting.type === 'boolean') {
                                                  ...
                                                  // Show the textarea group and populate it with the value
                                                  $('#editTextareaGroup').show(); // Make the textarea visible
                                                  // $('#editTextarea').val(setting.value);  // Populate the textarea with the text value
                                                  tinymce.get("editTextarea").setContent(setting.value);
                                        } else {
                                                  $('#editValue').val(setting.value);
                                                  $('#editTextareaGroup').hide();  // Hide the textarea if the type is not 'text'
                                        }
