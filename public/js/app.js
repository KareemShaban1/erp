$(document).ready(function() {
    ...
    $('.contact_modal').on('shown.bs.modal', function(e) {
        ...
        if ($('select#contact_type').val() == 'customer') {
            ...
            $('div.delivery_fields').hide();
        }else if ($('select#contact_type').val() == 'client') {
            $('div.client_fields').show();
            $('div.supplier_fields').hide();
            $('div.customer_fields').hide();
            $('div.delivery_fields').hide();
        }else if ($('select#contact_type').val() == 'delivery') {
            $('div.delivery_fields').show();
            $('div.supplier_fields').hide();
            $('div.customer_fields').hide();
            $('div.clients_fields').hide();
...
if ($('#post_popup').length) {

    init_tinymce('post_popup');
}